...
public class MsgActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, SensorEventListener, View.OnTouchListener {

    private final static String TAG = "MsgActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mChatView.setMenuClickListener(new OnMenuClickListener() {
            ...
            public boolean onSendTextMessage(CharSequence input) {
                ...
                message.setUserInfo(new DefaultUser("1", "Ironman", "R.drawable.ic_launcher"));
            ...
            public boolean switchToMicrophoneMode() {
                ...
                if (!EasyPermissions.hasPermissions(MsgActivity.this, perms)) {
                    EasyPermissions.requestPermissions(MsgActivity.this,
...
//                mChatView.getChatInputView().getSelectPhotoView().updateData();
        ...
        mChatView.getSelectAlbumBtn().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(MsgActivity.this, "OnClick select album button",
    ...
    private List<MyMessage> getMessages() {
        ...
        for (int i = 0; i < messages.length; i++) {
            ...
            if (i % 2 == 0) {
                ...
                message.setUserInfo(new DefaultUser("0", "DeadPool", "R.drawable.ic_launcher"));
            } else {
...
//                    Intent intent = new Intent(MsgActivity.this, BrowserImageActivity.class);
...
//                        Toast.LENGTH_SHORT).show();
        ...
        voiceMessage.setUserInfo(new DefaultUser("0", "Deadpool", "R.drawable.ic_launcher"));
        ...
        sendVoiceMsg.setUserInfo(new DefaultUser("1", "Ironman", "R.drawable.ic_launcher"));
        ...
        receiveVideo.setUserInfo(new DefaultUser("0", "Deadpool", "R.drawable.ic_launcher"));
        ...
        layout.setPtrHandler(new PtrHandler() {
            ...
            public void onRefreshBegin(PullToRefreshLayout layout) {
                Log.i("MsgActivity", "Loading next page");
                loadNextPage();
            }
        });
